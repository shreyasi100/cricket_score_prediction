...
#print(team_b)
print()
s1 = sim(team_a, team_b)
s2 = sim(team_c, team_d)
print("Runs scored by team 1: ", s1)
print("Runs scored by team 2: ", s2)
if(s1 > s2):
